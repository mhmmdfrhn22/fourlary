                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        <div className="lg:max-w-lg">
                            <p className="text-lg font-semibold text-indigo-600">Visi Misi Sekolah SMKN 4 Bogor</p>
                            ...
                            <p className="font-semibold mt-8 text-4xl text-gray-400">
                                Visi sekolah SMK Negeri 4 Bogor adalah <span className="font-semibold mt-6 text-4xl text-gray-700">“Terwujudnya sekolah yang tangguh dalam imtaq, terampil, mandiri, berbasis Teknologi Informasi dan Komunikasi, dan berwawasan lingkungan”</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white py-24 sm:py-16">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:text-center">
                        <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance">Misi Misi Sekolah SMK Negeri 4 Bogor</p>
                        <p class="mt-6 text-lg/8 text-gray-700">Berikut adalah Misi Misi dari Sekolah SMKN Negeri 4 Bogor Sebagai Berikut</p>
                    </div>
                    <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
                        <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                            <div class="relative pl-16">
                                ...
                                <dd class="mt-2 text-base/7 text-gray-600">Mewujudkan peserta didik yang beriman dan bertaqwa kepada Tuhan Yang Maha Esa, berakhlak mulia, berjiwa gotong royong, mandiri, kreatif, bernalar kritis, serta mampu beradaptasi dalam keberagaman global.</dd>
                            </div>
                            <div class="relative pl-16">
                                <dt class="text-base/7 font-semibold text-gray-900">
                                    <div class="absolute top-0 left-0 flex size-10 items-center justify-center rounded-lg bg-indigo-600">
                                ...
                                <dd class="mt-2 text-base/7 text-gray-600">Mengembangkan pembelajaran dan pengelolaan sekolah dengan memanfaatkan Teknologi Informasi dan Komunikasi (TIK) untuk mendukung kualitas pendidikan.</dd>
                            </div>
                            <div class="relative pl-16">
                                <dt class="text-base/7 font-semibold text-gray-900">
                                    <div class="absolute top-0 left-0 flex size-10 items-center justify-center rounded-lg bg-indigo-600">
                                ...
                                <dd class="mt-2 text-base/7 text-gray-600">Mengembangkan sekolah yang berwawasan Adiwiyata Mandiri dengan menanamkan kepedulian lingkungan dan prinsip pembangunan berkelanjutan.</dd>
                            </div>
                            <div class="relative pl-16">
                                <dt class="text-base/7 font-semibold text-gray-900">
                                    <div class="absolute top-0 left-0 flex size-10 items-center justify-center rounded-lg bg-indigo-600">
                                ...
                                <dd class="mt-2 text-base/7 text-gray-600">Mengembangkan berbagai bidang usaha sekolah secara optimal agar memiliki kemandirian, inovasi, serta daya saing yang tinggi.</dd>
                            </div>
                        </dl>
                    </div>
                </div>
