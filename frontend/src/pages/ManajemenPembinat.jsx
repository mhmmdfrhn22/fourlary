...
const API_URL = "http://localhost:3000/api/pembinat";
...
export default function ManajemenPembinat() {
  ...
  // 🔹 Fetch pembimbing untuk dropdown
  const fetchPembimbing = async () => {
    try {
      const res = await fetch("http://localhost:3000/api/pembimbing");
            ...
            {filteredData.map((p, index) => (
              <TableRow key={p.id_pekerjaan}>
                ...
                <TableCell>
                  {p.gambar_pekerjaan ? (
                    <img
                      src={`http://localhost:3000/uploads/pembinat/${p.gambar_pekerjaan}`}
              ...
              <div className="grid gap-4">
                ...
                <div>
                  ...
                  {editing.gambar_pekerjaan && (
                    <img
                      src={`http://localhost:3000/uploads/pembinat/${editing.gambar_pekerjaan}`}
                      alt="preview"
