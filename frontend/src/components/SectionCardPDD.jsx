        ...
        const fetchStats = async () => {
            try {
                ...
                const [beritaRes, fotoRes, likesRes, komentarRes] = await Promise.all([
                    fetch(`http://localhost:3000/api/posts/count/${userId}`).then(r => r.json()),
                    fetch(`http://localhost:3000/api/foto/count/${userId}`).then(r => r.json()),
                    fetch(`http://localhost:3000/api/like-foto/count/${userId}`).then(r => r.json()),
                    fetch(`http://localhost:3000/api/komentar-foto/count/${userId}`).then(r => r.json()),
                ]);
