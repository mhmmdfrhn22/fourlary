    ...
    const fetchCounts = async () => {
      try {
        const [usersRes, postsRes, publikasiRes, photosRes] = await Promise.all([
          fetch("http://localhost:3000/api/user/count").then(res => res.json()),
          fetch("http://localhost:3000/api/posts/count").then(res => res.json()),
          fetch("http://localhost:3000/api/user/publikasi/count").then(res => res.json()),
          fetch("http://localhost:3000/api/foto/count").then(res => res.json()),
        ])
